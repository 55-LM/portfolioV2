            ...
            >
              <div className="flex items-baseline justify-between">
                ...
                <div className="flex items-baseline gap-4 ml-4">
                  ...
                  <a href="mailto:" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
                    <img src={mailIcon} alt="Email" className="w-7 h-7 object-contain" />
                  </a>
                  <a href="https://leetcode.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
